              ...
              <div class=".col-md-6 .offset-md-3">
                <div class="col-md-5 order-md-last pr-md-5">
                  ...
                  <form method="post" action="<?php echo base_url('login/cek_login'); ?>" class=" p-3 p-md-5 bg-light">
                    <!--  <img src="<?php echo base_url(); ?>assets/images/sisi.png" /> -->
                    ...
                    <div class="form-group">
                      <button href="<?php echo base_url('login/ceklogin'); ?>" type="submit" name="login" class="btn btn-secondary btn-lg btn-block">Login</button>
                    </div>
            </center>
          </div>
          </form>
