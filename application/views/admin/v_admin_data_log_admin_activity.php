                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url('admin/aksi_admin/hapus_data_log_admin_activity') ?>?id_log_admin=<?php echo $a['id_log_admin'] ?>&nama_produk=<?php echo $a['produk'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
