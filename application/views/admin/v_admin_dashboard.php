...
<div class="container-fluid" id="container-wrapper">
  ...
  <div class="row mb-3">
        ...
        <div class="card-body" href="index.html">
          <a href="<?php echo base_url('admin/admin/list_data_case') ?>">
            <div class="row align-items-center">
              <div class="col mr-2">
                <div class="h5 mb-0 font-weight-bold text-gray-800">Data Case</div>
        ...
        <div class="card-body">
          <a href="<?php echo base_url('admin/admin/list_data_comment') ?>">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="h5 mb-0 font-weight-bold text-gray-800">Data Comment</div>
                <div class="h6 mb-0 font-weight-bold text-gray-800">Preview</div>
      ...
      <div class="card h-100">
        <div class="card-body">
          <a href="<?php echo base_url('admin/admin/list_data_employee') ?>">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="h5 mb-0 font-weight-bold text-gray-800">Data Employee</div>
                <div class="h6 mb-0 font-weight-bold text-gray-800">Preview</div>
      ...
      <div class="card h-100">
        <div class="card-body">
          <a href="<?php echo base_url('admin/admin/list_data_log') ?>">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="h5 mb-0 font-weight-bold text-gray-800">Data Log</div>
                <div class="h6 mb-0 font-weight-bold text-gray-800">Preview</div>
    ...
    <div class="col-xl-2 col-md-6 mb-4">
      <div class="card h-100">
        <div class="card-body">
          <a href="<?php echo base_url('admin/admin/list_data_category') ?>">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
