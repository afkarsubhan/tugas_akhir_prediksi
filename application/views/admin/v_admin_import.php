    ...
    <div id="wrapper">
        ...
        <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Form Import</h1>
                <ol class="breadcrumb">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <?php foreach ($data as $a) { ?>
                                <form action="<?php echo base_url('admin/c_produk/do_edit_data_produk') ?>?id_produk=<?php echo $a['id_produk'] ?>" method="post">

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Kode Produk</label>
                                        <input type="text" class="form-control" aria-describedby="" required="" value="<?php echo $a['id_produk'] ?>" disabled="">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nama Produk</label>
                                        <input type="text" class="form-control" name="nama_produk" aria-describedby="" required="" value="<?php echo $a['nama_produk'] ?>">
                                    </div>
