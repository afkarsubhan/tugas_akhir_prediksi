...
--
-- Host: localhost
-- Generation Time: May 31, 2021 at 06:03 PM
...
INSERT INTO `barang` (`id_barang`, `kode_barang`) VALUES
(2, 'Bolpoint'),
(1, 'Buku');
...
INSERT INTO `penjualan` (`id_penjualan`, `bulan_penjualan`, `tahun_penjualan`, `jumlah_penjualan`, `id_produk`) VALUES
(6, 'Januari', 2017, 2001, 6),
(7, 'Januari', 2018, 220, 6);
...
INSERT INTO `produk` (`id_produk`, `nama_produk`, `kode_barang`) VALUES
(6, 'Standart', 'bolpoint'),
(13, 'Sinar Dunia', 'Buku'),
(14, 'Pistol', 'bolpoint');
